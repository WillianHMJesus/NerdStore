...
namespace NerdStore.Core.Messages.CommonMessages.IntegrationEvents
{
    ...
    {
        public StartOrderEvent(Guid orderId, Guid clientId, decimal amount, OrderProductListDTO items, string cardName, string cardNumber, string cardExpiration, string cardSecurityCode)
        {
            OrderId = orderId;
            ClientId = clientId;
            Amount = amount;
